...
namespace OrionBot.Engine.LevelSystem
{
    public class LevelEngine
    {
        ...
        public bool StoreUserDetails(DUser user)
        {
            try
            {
                var path = @"C:\Users\kaanl\Documents\Programlama\Code\OrionBot\OrionBot\bin\Debug\UserInfo.json";
        ...
        public bool CheckedUserExists(string username, ulong guildID)
        {
